...
import {
  ...
  draftEmail, draftEmail2, message3, message4,
} from './dummy';
...
describe('MESSAGE ENDPOINT TESTS', () => {
  ...
  it('Should not send this email because the sender and receiver emails are the same', (done) => {
    chai.request(server)
      ...
      .end((err, res) => {
        ...
        res.body.should.have.property('error').eql('the sender and receiver email must not be the same');
        res.body.should.be.a('object');
        done();
      });
  });
  ...
  it('Should retrieve received emails', (done) => {
    chai.request(server)
      ...
      .end((err, res) => {
        res.body.should.have.status(200);
        res.body.should.have.property('status').eql(200);
        res.body.should.have.property('success').eql('admin, received emails retrieved');
        res.body.should.be.a('object');
        res.body.data.should.be.a('array');
        done();
      });
  ...
  it('Should retrieve sent email of id 1', (done) => {
    chai.request(server)
      ...
      .end((err, res) => {
        res.body.should.have.status(200);
        res.body.should.have.property('status').eql(200);
        res.body.should.have.property('success').eql('admin, sent email retrieved');
        res.body.should.be.a('object');
        res.body.data.should.be.a('array');
        done();
      });
  ...
  it('Should not retrieve sent email of id 6 because it does not exist', (done) => {
    chai.request(server)
      ...
      .end((err, res) => {
        res.body.should.have.status(404);
        res.body.should.have.property('status').eql(404);
        res.body.should.have.property('error').eql('admin, sent email not found');
        res.body.should.be.a('object');
        done();
      });
  });
  ...
  it('Should retrieve received email of id 1', (done) => {
    chai.request(server)
      ...
      .end((err, res) => {
        res.body.should.have.status(200);
        res.body.should.have.property('status').eql(200);
        res.body.should.have.property('success').eql('admin, received email retrieved');
        res.body.should.be.a('object');
        res.body.data.should.be.a('array');
        done();
      });
  ...
  it('Should retrieve received email of id 2', (done) => {
    chai.request(server)
      ...
      .end((err, res) => {
        res.body.should.have.status(200);
        res.body.should.have.property('status').eql(200);
        res.body.should.have.property('success').eql('received email retrieved');
        res.body.should.be.a('object');
        res.body.data.should.be.a('array');
        done();
      });
  ...
  it('Should retrieve read emails', (done) => {
    chai.request(server)
      ...
      .end((err, res) => {
        res.body.should.have.status(200);
        res.body.should.have.property('status').eql(200);
        res.body.should.have.property('success').eql('your read emails retrieved');
        res.body.should.be.a('object');
        res.body.data.should.be.a('array');
        done();
      });
  ...
  it('Should retrieve draft email of id 1', (done) => {
    chai.request(server)
      ...
      .end((err, res) => {
        res.body.should.have.status(200);
        res.body.should.have.property('status').eql(200);
        res.body.should.have.property('success').eql('admin, draft email retrieved');
        res.body.should.be.a('object');
        res.body.data.should.be.a('array');
        done();
      });
  ...
  it('Should not retrieve draft email of id 6 because it does not exist', (done) => {
    chai.request(server)
      ...
      .end((err, res) => {
        res.body.should.have.status(404);
        res.body.should.have.property('status').eql(404);
        res.body.should.have.property('error').eql('admin, draft email not found');
        res.body.should.be.a('object');
        done();
      });
  });
  ...
  it('Should delete received email of id = 3', (done) => {
    chai.request(server)
      ...
      .end((err, res) => {
        res.body.should.have.status(200);
        res.body.should.have.property('status').eql(200);
        res.body.should.have.property('success').eql('received email deleted by admin');
        res.body.should.be.a('object');
        done();
      });
  });
  ...
  it('Should not delete received email of id = 4 because it does not exist', (done) => {
    chai.request(server)
      ...
      .end((err, res) => {
        res.body.should.have.status(404);
        res.body.should.have.property('status').eql(404);
        res.body.should.have.property('error').eql('admin, received email not found');
        res.body.should.be.a('object');
        done();
      });
  });
  ...
  it('Should delete sent email of id = 2', (done) => {
    chai.request(server)
      ...
      .end((err, res) => {
        res.body.should.have.status(200);
        res.body.should.have.property('status').eql(200);
        res.body.should.have.property('success').eql('sent email deleted by admin');
        res.body.should.be.a('object');
        done();
      });
  });
  ...
  it('Should delete draft email of id = 2', (done) => {
    chai.request(server)
      ...
      .end((err, res) => {
        res.body.should.have.status(200);
        res.body.should.have.property('status').eql(200);
        res.body.should.have.property('success').eql('draft email deleted by admin');
        res.body.should.be.a('object');
        done();
      });
  });
  ...
  it('Should not retrieve draft emails because they will have been deleted', (done) => {
    chai.request(server)
      ...
      .end((err, res) => {
        res.body.should.have.status(404);
        res.body.should.have.property('status').eql(404);
        res.body.should.have.property('error').eql('admin, no draft emails found');
        res.body.should.be.a('object');
        done();
      });
  });
  ...
  it('Should not retrieve unread emails they have been read', (done) => {
    chai.request(server)
      ...
      .end((err, res) => {
        res.body.should.have.status(404);
        res.body.should.have.property('status').eql(404);
        res.body.should.have.property('error').eql('admin, no unread emails found');
        res.body.should.be.a('object');
        done();
      });
  });
  ...
  it('Should not retrieve read emails because they will have been deleted', (done) => {
    chai.request(server)
      ...
      .end((err, res) => {
        res.body.should.have.status(404);
        res.body.should.have.property('status').eql(404);
        res.body.should.have.property('error').eql('admin, no read emails found');
        res.body.should.be.a('object');
        done();
      });
  });
  ...
  it('Should not retrieve sent emails because they will have been deleted', (done) => {
    chai.request(server)
      ...
      .end((err, res) => {
        res.body.should.have.status(404);
        res.body.should.have.property('status').eql(404);
        res.body.should.have.property('error').eql('admin, no sent emails found');
        res.body.should.be.a('object');
        done();
      });
  });
  ...
  it('Should not retrieve sent emails because they will have been deleted', (done) => {
    chai.request(server)
      ...
      .end((err, res) => {
        res.body.should.have.status(404);
        res.body.should.have.property('status').eql(404);
        res.body.should.have.property('error').eql('sorry! you have sent no emails!');
        res.body.should.be.a('object');
        done();
      });
  });
  ...
  it('Should not retrieve received emails because they will have been deleted', (done) => {
    chai.request(server)
      ...
      .end((err, res) => {
        res.body.should.have.status(404);
        res.body.should.have.property('status').eql(404);
        res.body.should.have.property('error').eql('admin, received emails not found');
        res.body.should.be.a('object');
        done();
      });
  });
  ...
  database('TRUNCATE TABLE receivedemails CASCADE; ALTER SEQUENCE receivedemails_id_seq RESTART WITH 1;');
  database('TRUNCATE TABLE sentemails CASCADE; ALTER SEQUENCE sentemails_id_seq RESTART WITH 1;');
  database('TRUNCATE TABLE draftemails CASCADE; ALTER SEQUENCE draftemails_id_seq RESTART WITH 1;');
});
